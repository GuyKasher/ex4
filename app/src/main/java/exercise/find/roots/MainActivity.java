...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    broadcastReceiverForSuccess = new BroadcastReceiver() {
      ...
      long num1=incomingIntent.getLongExtra("root1",0);
      long num2=incomingIntent.getLongExtra("root2",0);
      long original_number=incomingIntent.getLongExtra("original_number",0);
      String time=incomingIntent.getStringExtra("time");
      Intent intentToOpenSuccess = new Intent(MainActivity.this, success.class);
    ...
    broadcastReceiverForFail=new BroadcastReceiver(){
      ...
      public void onReceive(Context context, Intent intent) {
        ...
        String time=intent.getStringExtra("time_until_give_up_seconds");

        Toast.makeText(context,"calculation aborted after "+time +"seconds ",Toast.LENGTH_SHORT).show();
  ...
  protected void onSaveInstanceState(@NonNull Bundle outState) {
    ...
    EditText editTextUserInput = findViewById(R.id.editTextInputNumber);
    Button buttonCalculateRoots = findViewById(R.id.buttonCalculateRoots);
    outState.putBoolean("progressBar",progressBar.isEnabled());
    outState.putBoolean("editTextUserInput",editTextUserInput.isEnabled());
  ...
  protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
    ...
    EditText editTextUserInput = findViewById(R.id.editTextInputNumber);
    Button buttonCalculateRoots = findViewById(R.id.buttonCalculateRoots);
    progressBar.setEnabled(savedInstanceState.getBoolean("progressBar"));
    editTextUserInput.setEnabled(savedInstanceState.getBoolean("editTextUserInput"));
